...
<Callout emoji="📖">
Keith Rabois has written an excellent piece on what it means to be a leader that we have reprinted in full in the appendix: [What does it mean to be an executive?](/appendices/be-an-executive)
</Callout>
