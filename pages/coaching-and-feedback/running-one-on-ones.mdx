...
When people commit to doing something, it's very important that you hold them accountable to that. Ensure that any commitment is written down in Asana with an owner and a due date to remove all disambiguation. We call these [Impeccable agreements](https://www.notion.so/Impeccable-agreements-29c18a2a68454ba1b6fb5e044b3e9bb0) .
...
Any issues that crop up should be written up in the issue style (see [Issue resolving](https://www.notion.so/Issue-resolving-4a7fba3dffee43698173d40348a88c85)) and created as Asana tasks under the Issues section. Ideally, they also have a proposed solution that you can quickly approve. For example:
...
3. **It's required that...** behavior that needs to change/improve, otherwise the next step is [Performance improvement plans (PIPS)](https://www.notion.so/Performance-improvement-plans-PIPS-61cafa24f7e148c4bbc7092a99d76c81).
...
Read our chapter dedicated to feedback before giving or receiving any feedback: [Feedback](https://www.notion.so/Feedback-23dd428653f94a7eb2725c2dbe9b4ec9).
...
6. Lastly comes feedback. We have written a whole chapter on this ([Feedback](https://www.notion.so/Feedback-23dd428653f94a7eb2725c2dbe9b4ec9)), but the key aspect is that if there is any critical feedback, there is mutual trust that it will be shared.
