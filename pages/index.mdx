...
<Callout emoji="🌟">
  This book is now available in [Kindle and paperback
  formats](https://www.amazon.com/Managers-Handbook-Alex-MacCaw-ebook/dp/B09DFFM91C/)
  on Amazon.
</Callout>

<div className="ml-auto mr-auto mb-10 sm:float-right sm:ml-10 sm:mr-0 rounded-md overflow-hidden shadow-sm">
  <Image src="/cover/cover-1720x2580px.png" width="360" height="540" />
</div>
